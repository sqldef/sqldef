...
- [ ] **Migrate tables tests** (14 commits):
  ...
  - [ ] Commit: `TestMysqldefAddColumnWithNull` → tests_tables.yml
  - [ ] Commit: `TestMysqldefChangeColumn` → tests_tables.yml
  - [ ] Commit: `TestMysqldefChangeColumnLength` → tests_tables.yml
  - [ ] Commit: `TestMysqldefChangeColumnBinary` → tests_tables.yml
...
- [ ] **Migrate indices tests** (12 commits):
  ...
  - [ ] Commit: `TestMysqldefAddIndex` → tests_indices.yml
  - [ ] Commit: `TestMysqldefAddIndexWithKeyLength` → tests_indices.yml
  - [ ] Commit: `TestMysqldefIndexOption` → tests_indices.yml
  - [ ] Commit: `TestMysqldefMultipleColumnIndexesOption` → tests_indices.yml
  - [ ] Commit: `TestMysqldefFulltextIndex` → tests_indices.yml
