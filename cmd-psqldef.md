...
| `manage_privileges_only` | boolean | When true, skips CREATE/ALTER/DROP ROLE operations and manages only GRANT/REVOKE privileges. Useful when roles are managed externally. Default is false. |
