...
type SQLNode interface {
	Format(buf *stringBuilder)
}

// stringBuilder extends strings.Builder to format SQLNode easily.
type stringBuilder struct {
	strings.Builder
}

// Printf mimics fmt.Fprintf(buf, ...), but limited to %s for string and %v for Node.
func (buf *stringBuilder) Printf(format string, values ...interface{}) {
	end := len(format)
	fieldnum := 0
	for i := 0; i < end; {
		lasti := i
...
func (node *Select) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *ParenSelect) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Union) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Stream) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Insert) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Update) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Delete) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Set) Format(buf *stringBuilder) {
	if node.Scope == "" {
...
// Format formats the node.
func (node *DBDDL) Format(buf *stringBuilder) {
	switch node.Action {
	case CreateStr:
...
// Format formats the node.
func (node *DDL) Format(buf *stringBuilder) {
	switch node.Action {
	case CreateStr:
...
// Format formats the node.
func (node *PartitionSpec) Format(buf *stringBuilder) {
	switch node.Action {
	case ReorganizeStr:
...
// Format formats the node
func (node *PartitionDefinition) Format(buf *stringBuilder) {
	if !node.Maxvalue {
...
// Format formats the node.
func (ts *TableSpec) Format(buf *stringBuilder) {
	buf.Printf("(\n")
...
// Format formats the node.
func (col *ColumnDefinition) Format(buf *stringBuilder) {
...
func (ct *ColumnType) Format(buf *stringBuilder) {
...
// Format formats the node.
func (idx *IndexDefinition) Format(buf *stringBuilder) {
...
// Format formats the node.
func (ii *IndexInfo) Format(buf *stringBuilder) {
	if ii.Primary {
...
func (node *VindexSpec) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node VindexParam) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Show) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *ShowFilter) Format(buf *stringBuilder) {
	if node.Like != "" {
...
// Format formats the node.
func (node *Use) Format(buf *stringBuilder) {
	if node.DBName.v != "" {
...
// Format formats the node.
func (node *Begin) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Commit) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Rollback) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *OtherRead) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *OtherAdmin) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *SetBoolOption) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node Comments) Format(buf *stringBuilder) {
	for _, c := range node {
		buf.Printf("%s ", c)
	}
}
...
// Format formats the node.
func (node SelectExprs) Format(buf *stringBuilder) {
	var prefix string
	for _, n := range node {
...
// Format formats the node.
func (node *StarExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *AliasedExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node Columns) Format(buf *stringBuilder) {
	if node == nil {
		return
	}
	prefix := "("
...
// Format formats the node
func (node Partitions) Format(buf *stringBuilder) {
	if node == nil {
		return
	}
	prefix := " partition ("
...
// Format formats the node.
func (node TableExprs) Format(buf *stringBuilder) {
	var prefix string
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *AliasedTableExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node TableNames) Format(buf *stringBuilder) {
	var prefix string
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node TableName) Format(buf *stringBuilder) {
	if node.isEmpty() {
		return
	}
	if node.Schema != "" {
...
// Format formats the node.
func (node *ParenTableExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node JoinCondition) Format(buf *stringBuilder) {
	if node.On != nil {
...
// Format formats the node.
func (node *JoinTableExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *IndexHints) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Where) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node Exprs) Format(buf *stringBuilder) {
	var prefix string
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *AndExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *OrExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *NotExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *ParenExpr) Format(buf *stringBuilder) {
	buf.Printf("(%v)", node.Expr)
}
...
// Format formats the node.
func (node *ComparisonExpr) Format(buf *stringBuilder) {
	if node.All {
...
// Format formats the node.
func (node *RangeCond) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *IsExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *ExistsExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *NullVal) Format(buf *stringBuilder) {
	buf.Printf("null")
}
...
// Format formats the node.
func (node BoolVal) Format(buf *stringBuilder) {
	if node {
		buf.Printf("true")
	} else {
		buf.Printf("false")
...
// Format formats the node.
func (node *ColName) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node ValTuple) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *Subquery) Format(buf *stringBuilder) {
	buf.Printf("(%v)", node.Select)
}
...
// Format formats the node.
func (node ListArg) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *BinaryExpr) Format(buf *stringBuilder) {
	buf.Printf("%v %s %v", node.Left, node.Operator, node.Right)
}
...
// Format formats the node.
func (node *UnaryExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *IntervalExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *CollateExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *FuncExpr) Format(buf *stringBuilder) {
	var distinct string
	if node.Distinct {
		distinct = "distinct "
	}
...
func (node *FuncCallExpr) Format(buf *stringBuilder) {
	// Function names should not be back-quoted even
	// if they match a reserved word. So, print the
	// name as is.
...
// Format formats the node
func (node *GroupConcatExpr) Format(buf *stringBuilder) {
...
// Format formats the node
func (node *OverExpr) Format(buf *stringBuilder) {
	if node == nil {
		return
	}
...
// Format formats the node.
func (node *ValuesFuncExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *SubstrExpr) Format(buf *stringBuilder) {
	if node.To == nil {
...
func (node *CastExpr) Format(buf *stringBuilder) {
...
func (node *ConvertExpr) Format(buf *stringBuilder) {
...
func (node *ConvertUsingExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *ConvertType) Format(buf *stringBuilder) {
...
// Format formats the node
func (node *MatchExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *CaseExpr) Format(buf *stringBuilder) {
	buf.Printf("case ")
	if node.Expr != nil {
		buf.Printf("%v ", node.Expr)
	}
...
// Format formats the node.
func (node *Default) Format(buf *stringBuilder) {
	buf.Printf("default")
	if node.ColName != "" {
...
// Format formats the node.
func (node *NextSeqValExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node *When) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node GroupBy) Format(buf *stringBuilder) {
	prefix := " group by "
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node OrderBy) Format(buf *stringBuilder) {
	prefix := " order by "
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *Order) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node PartitionBy) Format(buf *stringBuilder) {
	prefix := "partition by "
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *Partition) Format(buf *stringBuilder) {
	if node == nil {
		return
	}
	buf.Printf("%v", node.Expr)
...
// Format formats the node.
func (node *Limit) Format(buf *stringBuilder) {
	if node == nil {
		return
	}
	buf.Printf(" limit ")
...
// Format formats the node.
func (node Values) Format(buf *stringBuilder) {
	prefix := "values "
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node UpdateExprs) Format(buf *stringBuilder) {
	var prefix string
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node *UpdateExpr) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node SetExprs) Format(buf *stringBuilder) {
	var prefix string
	for _, n := range node {
		buf.Printf("%s%v", prefix, n)
		prefix = ", "
...
// Format formats the node.
func (node OnDup) Format(buf *stringBuilder) {
	if node == nil {
		return
	}
...
// Format formats the node.
func (node ColIdent) Format(buf *stringBuilder) {
...
func (node *Declare) Format(buf *stringBuilder) {
	var prefix string
	buf.Printf("declare\n")
	switch node.Type {
...
func (node *LocalVariable) Format(buf *stringBuilder) {
...
func (node *CursorDefinition) Format(buf *stringBuilder) {
...
func (node *Cursor) Format(buf *stringBuilder) {
...
func (node *BeginEnd) Format(buf *stringBuilder) {
	buf.Printf("begin")
...
func (node *While) Format(buf *stringBuilder) {
...
func (node *If) Format(buf *stringBuilder) {
...
// Format formats the node.
func (node TableIdent) Format(buf *stringBuilder) {
...
func (node *ArrayConstructor) Format(buf *stringBuilder) {
	buf.Printf("ARRAY[%v]", node.Elements)
}

type ArrayElements []ArrayElement

func (node ArrayElements) Format(buf *stringBuilder) {
	for i, n := range node {
		if i == 0 {
			buf.Printf("%v", n)
		} else {
